        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Lauro"),
                    new Professor(2, 2, "Roberto","Roberto"),
                    new Professor(3, 3, "Ronaldo", "Ronaldo"),
                    new Professor(4, 4, "Rodrigo", "Rodrigo"),
                    new Professor(5, 5, "Alexandre", "Alexandre")
                });
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>
                {
                    ...
                    new Curso(2,"Sistemas para Internet"),
