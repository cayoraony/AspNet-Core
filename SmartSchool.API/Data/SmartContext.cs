        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", "Lauro"),
                    new Professor(2, "Roberto","Roberto"),
                    new Professor(3, "Ronaldo", "Ronaldo"),
                    new Professor(4, "Rodrigo", "Rodrigo"),
                    new Professor(5, "Alexandre", "Alexandre"),
                });
