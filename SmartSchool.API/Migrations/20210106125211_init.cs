    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Lauro", "Lauro" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 2, "Roberto", "Roberto" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 3, "Ronaldo", "Ronaldo" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 4, "Rodrigo", "Rodrigo" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 5, "Alexandre", "Alexandre" });
